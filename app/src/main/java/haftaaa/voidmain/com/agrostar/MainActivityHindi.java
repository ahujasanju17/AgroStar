...
public class MainActivityHindi extends AppCompatActivity implements SearchView.OnQueryTextListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        text_featured.setText(" विशेष उत्पाद ");

        Titles = getResources().getStringArray(R.array.list_items_hindi);
        Prices= getResources().getStringArray(R.array.list_items_price_hindi);
        ...
        if (cursor != null) {
            ...
            myList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Toast.makeText(MainActivityHindi.this, selectedName, Toast.LENGTH_SHORT).show();
